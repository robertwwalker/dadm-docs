...
This is **tidy** though the names are bad but that can be fixed.  Let me store this __long__ table as an object to manipulate and fix the names.  __Long__ and **tidy** are interchangeable in the way that I use the terms.  Without further ado, here is the example. 
